g% it is the modify version of test_res_net.m 

% I want to transfer it to adapt to the alexnet.
...
%4. TRAIN Network & PREPROCESS images:
    ...
    % infactly test_idx is an incremental ID vector , the increment is 'num_folds';
    ...
    % infactly train_idx is the complement ID set of test_idx in the whole
    % imagedataset.
    ...
    %ResNetArchitecture
        ...
        %Replacing the last learnable layers withnew layers
        %01. fullconnectedlayer
    ...
    % size of posterior is 41height*2width
        ...
        save(sprintf('Alexnet_%d_among_%d_folds',fold_idx,num_folds),'netTransfer','test_idx','train_idx');
